        ...
        <div className="flex-1">
          ...
          <ul className="flex items-center gap-3 sm:gap-5">
            ...
            {toolsData.map((tool, index) => (
              ...
              <li key={index} className="flex items-center justify-center w-12 sm:w-14 aspect-square border rounded-lg cursor-pointer border-gray-400 hover:bg-gray-700 hover:-translate-y-2 duration-500 hover:shadow-[-4px_4px_8px_var(--color-gray-500)]">
